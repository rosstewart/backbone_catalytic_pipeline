...
RESULTS_DIR=../../graphlet_lsk_results_alph40
...
do
    ...
    #./run_kernel -p ${DATASET}/${id}.pos -n ${DATASET}/${id}.neg -g ${GRAPH_FILE} -l ${LABELS_FILE} -t 3 -M 0.34 -A AaCcDdEeFfGgHhIiKkLlMmNnPpQqRrSsTtVvWwYy -s ${RESULTS_DIR}/${id}_lsk.svml -N true -v
